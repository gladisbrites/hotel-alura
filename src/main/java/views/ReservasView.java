...
public class ReservasView extends JFrame {
	...
	private void guardarReserva() {
		...
		Reserva nuevaReserva= new Reserva(java.sql.Date.valueOf(fechaEntrada),
				java.sql.Date.valueOf(fechaSalida),txtValor.getText(),txtFormaPago.getSelectedItem().toString());
