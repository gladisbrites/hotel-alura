...
public class MenuPrincipal extends JFrame {
	...
	public MenuPrincipal() {
		...
		imagenFondo.setIcon(new ImageIcon(MenuPrincipal.class.getResource("/imagenes/recepcionHotel.png")));
		...
		JLabel lblCopyR = new JLabel("Desarrollado por Gladis Brites © 2023");
